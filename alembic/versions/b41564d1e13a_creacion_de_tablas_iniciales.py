...
Revision ID: b41564d1e13a
Revises: 
Create Date: 2026-02-17 15:39:25.893229
...
def upgrade() -> None:
    ...
    op.create_table('videojuegos_plataforma',
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('videojuegos_plataforma')
